...
arm64:
	...
	llvm-objcopy -O binary -j .text bin/usb_0xA1_2_arm64.o bin/usb_0xA1_2_arm64.bin
	...
	llvm-objcopy -O binary -j .text bin/checkm8_arm64.o bin/checkm8_arm64.bin
	...
	llvm-objcopy -O binary -j .text bin/t8010_t8011_disable_wxn_arm64.o bin/t8010_t8011_disable_wxn_arm64.bin
